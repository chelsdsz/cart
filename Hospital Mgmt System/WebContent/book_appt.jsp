                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="alert alert-success fade in">
                                 ...
                                 <c:if test='${msg == "" }'>
                                 <a href="<%=request.getContextPath() %>/Controller?page=existing_patient">Existing Patient</a>
                                 </c:if>
                        ...
                        <input type="hidden" name="page" value="book_appt_form">
                         ...
                         <BR><BR>	
                          ...
                          <label class="col-sm-2 control-label">Address:</label>
                                      <div class="col-sm-7">
                                          <input type="text" class="form-control" name="address" value="<c:out value="${address }"></c:out>">
                                      </div>                        
							<BR><BR> 
						<label class="col-sm-2 control-label">Contact:</label>
                                      <div class="col-sm-7">
                                          <input type="text" class="form-control" name="contact" value="<c:out value="${contact }"></c:out>">
                                      </div>	
                        <BR><BR> 
                        <HR>
                        <BR><BR>

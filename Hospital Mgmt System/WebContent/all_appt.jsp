...
AND date = '<%=DateFormat.getDateInstance().format(new Date()) %>';
</sql:query>   
...
<!-- Page Content -->
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                      <div class="col-lg-12">
                        <h1>All Appointments for Today(<%=DateFormat.getDateInstance().format(new Date()) %>)</h1>
                        </div>
                              ...
                              <c:forEach var="row" items="${result.rows}">
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      ...
                                      <a class="btn btn-danger" href="<%=request.getContextPath() %>/Controller?page=cancel_appt">Cancel Appointment</a>
                                  </div>
                                  </td>
                              </tr>
